...
FROM
        ...
        LEFT JOIN sierra_view.hold AS ih ON (
                ih.record_id = i.id
                AND ih.status = '0'
        )
        LEFT JOIN sierra_view.record_metadata AS rmb ON (
                rmb.id = b.id
